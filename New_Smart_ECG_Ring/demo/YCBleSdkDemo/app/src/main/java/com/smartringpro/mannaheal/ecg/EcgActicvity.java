...
import com.smartringpro.mannaheal.ecg.adapter.EcgHisListAdapter;
import com.smartringpro.mannaheal.ecg.bean.EcgSyncListResponse;
import com.smartringpro.mannaheal.ecg.util.SharedPreferencesUtil;
import com.smartringpro.mannaheal.ecg.view.Cardiograph2View;
    ...
    private void initListener() {
        ...
        adapter.setOnCall(new EcgHisListAdapter.OnCall() {
            ...
            public void setInfo(View v, int position) {
                switch (v.getId()) {
                    case R.id.tv_jilu:
                        startActivity(new Intent(EcgActicvity.this, EcgMsgActivity.class).putExtra("timeStr", lists.get(position)));
                        break;
                    case R.id.tv_jiance:
