...
import com.smartringpro.mannaheal.model.BandBaseInfo;
import com.smartringpro.mannaheal.model.HistEcgResponse;
    ...
    private void initView(){
        ...
        timeSetView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                YCBTClient.settingUnit(0, 0x00, 0x00, 0x01, 0x00, new BleDataResponse() {
                    @Override
