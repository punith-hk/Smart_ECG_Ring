package com.smartringpro.mannaheal.ecg.view;
...
public class CardiographView4 extends View {
    Context context;
    public List<Integer> plist = Collections.synchronizedList(new ArrayList<>());
    //画笔
    ...
    public int WidthDots = 0; ////add by shl 2018-08-22   //占满控件宽度时，坐标点的数量
