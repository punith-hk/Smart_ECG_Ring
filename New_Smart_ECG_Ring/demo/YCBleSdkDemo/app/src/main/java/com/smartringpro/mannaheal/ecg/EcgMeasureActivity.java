package com.smartringpro.mannaheal.ecg;
...
import com.smartringpro.mannaheal.ecg.util.SharedPreferencesUtil;
import com.smartringpro.mannaheal.ecg.view.CardiographView4;
import com.smartringpro.mannaheal.ecg.view.CommonDialog;
import com.smartringpro.mannaheal.ecg.view.EcgMeasurDialog;
import com.smartringpro.mannaheal.view.NavigationBar;
...
public class EcgMeasureActivity extends Activity {
    ...
    private long mFrameInterval = 16;
    private Runnable mRefreshRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (isStart) {
                mHandler.postDelayed(mRefreshRunnable, mFrameInterval);
            }
            if (drawLists.size() > 0 && isProgressBar) {
            ...
            public void onRealDataResponse(int i, HashMap hashMap) {
                if (hashMap != null) {
                    ...
                    if (i == Constants.DATATYPE.Real_UploadECG) {
                        ...
                        mRRValue = (float) hashMap.get("data");
                        Log.e("qob", "RR invo " + mRRValue);
                        ...
                        int ecgStatus = (int) hashMap.get("EcgStatus");//心电电极状态
                        int ppgStatus = (int) hashMap.get("PPGStatus");//光电传感器状态
                        if (ecgStatus == 1 || ppgStatus == 1) {
    ...
    public void makeStart() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (isStart) {
                    try {
                        if (mCardiographView == null) {
                            //                            Log.d("ltf", "mCardiographView == null");
                            isStart = false;
                            return;
                        }
                        Thread.sleep(12);
                        if (index < drawLists.size()) {
                            ...
                            synchronized (mCardiographView.plist) {
